      ...
      {product &&
        <div className={styles.product_block}>
          ...
          <div className={styles.product_info}>
            ...
            <div className={styles.product_descr}><span className={styles.description}>Description:</span>{product.description}</div>
            <div className={styles.buy_block}>
              ...
              {cart.find(el => el.product.id === product.id) ?
                (<div className={styles.buttons_wrapper}>
                  <span className={styles.changeQuantity} onClick={() => minusHandler(cart[cart.findIndex(el => el.product.id === product.id)]?.quantity)}><AiOutlineMinusCircle /></span>
                  <span className={styles.quantity}>{cart[cart.findIndex(el => el.product.id === product.id)]?.quantity}</span>
