...
const Home = () => {
  return (
    <>
      ...
      <div
        className='mt-14 w-[90%] mx-auto font-mono text-gray-300 bg-gray-900 px-1 py-2 md:w-[80%] lg:w-[70%] xl:w-[60%]'>
        <p>$ Welcome to my first pet-project /</p>
        <p>Sorry about such a boring main page. Probably it should be the products page here /</p>
        <p>This SPA works with <a className='no-underline text-cyan-700'
                                  href='https://fakestoreapi.com/'>fakestoreapi.com</a> API /</p>
        <p>There isn&apos;t much functionality here /</p>
        <p>Specifically, the following has been implemented: /</p>
        <p className='underline'>Authorization, getting goods from the server, search, sorting by category, adding
          products to cart and saving the session data /</p>
